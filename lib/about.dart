...
class _AboutPageState extends State<AboutPage> with TextUtil {
  ...
  static const fontCopy = 'The fonts used in this application have been chosen for their readability at a distance. "Clean" themes use the font Roboto, "Formal" themes use Noto Serif, and "Baroque" themes use EB Garamond, all from Google Fonts. "Highway" themes use Interstate, by Tobias Frere-Jones.';
