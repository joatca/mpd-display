...
class _AboutPageState extends State<AboutPage> with TextUtil {
  ...
  static const fontCopy = 'The fonts used in this application have been chosen for their readability at a distance. "Standard" themes use the font Roboto, "Formal" themes use Noto Serif, "Baroque" themes use EB Garamond, and "Techno" themes use Jura, all from Google Fonts.';
